...
function(COMPRESS_ZIP _outputFile)
	...
	if(ZIP_EXECUTABLE MATCHES "7z|7za")
		...
		add_custom_command(
			OUTPUT "${_outputFile}"
			COMMAND ${ZIP_EXECUTABLE} a -tzip -mtc=off ${_additionalOptions} ${_outputFile} ${_parsedArguments_PATHS}
	...
	elseif(ZIP_EXECUTABLE MATCHES "zip")
		...
		add_custom_command(
			OUTPUT "${_outputFile}"
			COMMAND ${ZIP_EXECUTABLE} -X -r ${_additionalOptions} ${_outputFile} ${_parsedArguments_PATHS}
			DEPENDS ${_depends_PATHS}
			WORKING_DIRECTORY "${_workingDirectory}"
			VERBATIM
		)
