...
$VCPKG_COMMIT_SHA = "556325a1f7b6049d91565257c00db2f0bf1eadc5";
...
{
	.\vcpkg install physfs harfbuzz libiconv libogg libtheora libvorbis libpng openal-soft sdl2 glew freetype gettext zlib curl[winssl];
