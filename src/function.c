...
BOOL loadFunctionStats(SBYTE *pFunctionData, UDWORD bufferSize)
{
	...
	for (i=0; i < totalFunctions; i++)
	{
		...
		FunctionType[0] = '\0';
		sscanf(pFunctionData, "%[^',']", &FunctionType[0]);
...
BOOL loadProductionUpgradeFunction(SBYTE *pData)
{
	...
	*asFunctions = (FUNCTION *)psFunction;
	...
	//read the data in
	functionName[0] = '\0';
	sscanf(pData, "%[^','],%d,%d,%d,%d", &functionName[0], &factory,
...
BOOL loadResearchFunction(SBYTE *pData)
{
	...
	*asFunctions = (FUNCTION *)psFunction;
	...
	//read the data in
	functionName[0] = '\0';
	sscanf(pData, "%[^','],%d", &functionName[0], &psFunction->researchPoints);
...
BOOL loadReArmFunction(SBYTE *pData)
{
	...
	*asFunctions = (FUNCTION *)psFunction;
	...
	//read the data in
	functionName[0] = '\0';
	sscanf(pData, "%[^','],%d", &functionName[0], &psFunction->reArmPoints);
...
BOOL loadUpgradeFunction(SBYTE *pData, UBYTE type)
{
	...
	*asFunctions = (FUNCTION *)psFunction;
	...
	//read the data in
	functionName[0] = '\0';
	sscanf(pData, "%[^','],%d", &functionName[0], &modifier);
...
BOOL loadDroidBodyUpgradeFunction(SBYTE *pData)
{
	...
	*asFunctions = (FUNCTION *)psFunction;
	...
	//read the data in
	functionName[0] = '\0';
	sscanf(pData, "%[^','],%d,%d,%d,%d,%d,%d", &functionName[0], &modifier, 
...
BOOL loadDroidSensorUpgradeFunction(SBYTE *pData)
{
	...
	*asFunctions = (FUNCTION *)psFunction;
	...
	//read the data in
	functionName[0] = '\0';
	sscanf(pData, "%[^','],%d,%d", &functionName[0], &modifier, &range);
...
BOOL loadWeaponUpgradeFunction(SBYTE *pData)
{
	...
	*asFunctions = (FUNCTION *)psFunction;
	...
	functionName[0] = '\0';
	weaponSubClass[0] = '\0';
	sscanf(pData, "%[^','],%[^','],%d,%d,%d,%d,%d,%d,%d", &functionName[0],
		&weaponSubClass[0], &firePause, &shortHit, &longHit, &damage, &radiusDamage,
...
BOOL loadStructureUpgradeFunction(SBYTE *pData)
{
	...
	*asFunctions = (FUNCTION *)psFunction;
	...
	//read the data in
	functionName[0] = '\0';
	sscanf(pData, "%[^','],%d,%d,%d", &functionName[0], &armour, &body, &resistance);
...
BOOL loadWallDefenceUpgradeFunction(SBYTE *pData)
{
	...
	*asFunctions = (FUNCTION *)psFunction;
	...
	//read the data in
	functionName[0] = '\0';
	sscanf(pData, "%[^','],%d,%d", &functionName[0], &armour, &body);
...
BOOL loadPowerGenFunction(SBYTE *pData)
{
	...
	*asFunctions = (FUNCTION *)psFunction;
	...
	//read the data in
	functionName[0] = '\0';
	sscanf(pData, "%[^','],%d,%d,%d,%d,%d,%d", &functionName[0], 
...
BOOL loadResourceFunction(SBYTE *pData)
{
	...
	*asFunctions = (FUNCTION *)psFunction;
	...
	//read the data in
	functionName[0] = '\0';
	sscanf(pData, "%[^','],%d", &functionName[0], &psFunction->maxPower);
...
//	STRUCTURE_STATS			*pStructStat;
	...
	*asFunctions = (FUNCTION*)psFunction;
	...
	functionName[0] = '\0';
	structureName[0] = '\0';
	sscanf(pData, "%[^','],%[^','],%*d", &functionName[0], &structureName[0]);
