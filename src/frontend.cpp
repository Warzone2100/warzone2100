...
void addBackdrop(void)
{
	...
	sFormInit.x = (SWORD)( ((getDualScreenCompat() ? pie_GetVideoBufferWidth() / 2 : pie_GetVideoBufferWidth())  - HIDDEN_FRONTEND_WIDTH)/2);//(SWORD) (pie_GetVideoBufferWidth() / 2 - (getDualScreenCompat() ? HIDDEN_FRONTEND_WIDTH : HIDDEN_FRONTEND_WIDTH / 2));
