...
#define MULTIOP_PLAYERS			(GAMES_GAMEEND+10)
...
#define MULTIOP_INLINE_OVERLAY_ROOT_FRM	(GAMES_GAMEEND+66)
...
#define MULTIOP_OPTIONS			(GAMES_GAMEEND+29)
...
#define MULTIOP_PNAME_ICON		(GAMES_GAMEEND+31)
#define MULTIOP_PNAME			(GAMES_GAMEEND+32)
#define MULTIOP_GNAME_ICON		(GAMES_GAMEEND+33)
#define MULTIOP_GNAME			(GAMES_GAMEEND+34)
#define MULTIOP_MAP_ICON		(GAMES_GAMEEND+37)
#define MULTIOP_MAP				(GAMES_GAMEEND+38)
#define MULTIOP_MAP_MOD			21013	// Warning, do not use sequential numbers until code is fixed.
#define MULTIOP_MAP_RANDOM      21014

#define MULTIOP_REFRESH			(GAMES_GAMEEND+54)

#define MULTIOP_HOST			(GAMES_GAMEEND+55)
...
#define MULTIOP_CHATBOX			(GAMES_GAMEEND+57)
...
#define MULTIOP_CHATEDIT		(GAMES_GAMEEND+58)
#define MULTIOP_CHATEDITX		4
#define MULTIOP_CHATEDITH		18
#define	MULTIOP_CHATEDITW		(MULTIOP_CHATBOXW - 8)

#define MULTIOP_COLCHOOSER_FORM         (GAMES_GAMEEND+59)
#define MULTIOP_COLCHOOSER              102711 //10281
#define MULTIOP_COLCHOOSER_END          102742 //10288

#define MULTIOP_LIMIT			(GAMES_GAMEEND+71)	// 2 for this (+label)
#define MULTIOP_GAMETYPE		(GAMES_GAMEEND+73)
#define MULTIOP_POWER			(GAMES_GAMEEND+75)
#define MULTIOP_ALLIANCES		(GAMES_GAMEEND+77)
#define MULTIOP_RANDOM			(GAMES_GAMEEND+78)
#define MULTIOP_BASETYPE		(GAMES_GAMEEND+79)
#define MULTIOP_TECHLEVEL		(GAMES_GAMEEND+80)
...
#define MULTIOP_NO_SOMETHING            (GAMES_GAMEEND+110)
...
#define MULTIOP_COLOUR_START		(GAMES_GAMEEND+111)
