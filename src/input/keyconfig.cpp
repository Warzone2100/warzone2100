...
static void initializeKeyFunctions(std::vector<KeyFunctionInfo>& entries)
{
	...
	entries.emplace_back(KeyFunctionInfo(InputContext::GAMEPLAY,            KeyMappingType::ASSIGNABLE,  kf_SelectUnits(DST_CYBORG_SUPER),                              "SelectAllCombatSuperCyborgs",  N_("Select all Super Cyborgs"),                     {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_LSHIFT,     KEY_CODE::KEY_Z             } }}));
	...
	entries.emplace_back(KeyFunctionInfo(InputContext::GAMEPLAY,            KeyMappingType::ASSIGNABLE,  kf_SelectNoGroupUnits(DST_CYBORG_SUPER),                       "SelectAllCombatSuperCyborgsNG",N_("Select all Super Cyborgs without group"),       {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_LSHIFT,     KEY_CODE::KEY_X             } }}));
