...
static void initializeKeyFunctions(std::vector<KeyFunctionInfo>& entries)
{
	...
	entries.emplace_back(KeyFunctionInfo(InputContext::BACKGROUND,      KeyMappingType::HIDDEN,      kf_PrioritizeDebugMappings,                                    "PrioritizeDebugMappings",      N_("Prioritize Debug Mappings"),                    {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_LALT,       KEY_CODE::KEY_BACKSPACE     } }}));
