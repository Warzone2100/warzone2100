...
static void initializeKeyFunctions(std::vector<KeyFunctionInfo>& entries)
{
	...
	entries.emplace_back(KeyFunctionInfo(InputContext::GAMEPLAY,            KeyMappingType::ASSIGNABLE,  kf_SetDroid(DSO_CIRCLE, DSS_CIRCLE_SET),                       "SetDroidMoveCircle",           N_("Circle"),                                       {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_LSHIFT,     KEY_CODE::KEY_Q             } }}));
