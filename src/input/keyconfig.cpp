...
static void initializeKeyFunctions(std::vector<KeyFunctionInfo>& entries)
{
	...
	entries.emplace_back(KeyFunctionInfo(InputContext::GAMEPLAY,            KeyMappingType::ASSIGNABLE,  kf_SelectUnits(DST_ALL_LAND_MILDLY_OR_NOT_DAMAGED),            "SelectAllLandMildNoDamage",    N_("Select all Combat Land units with health >50% and no Groups."), {}));
