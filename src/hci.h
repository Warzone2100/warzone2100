...
void setReticuleStats(int ButId, std::string tip = std::string(), QString filename = QString(), QString filenameDown = QString(), QString func = QString(), QScriptEngine *engine = nullptr);
