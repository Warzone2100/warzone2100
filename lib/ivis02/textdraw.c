...
BOOL iV_GetTextDetails(STRING Char, UWORD *Width, UWORD *Height, SWORD *YOffset, UBYTE *U, UBYTE *V, UWORD *TpageID)
{
...
void pie_DrawTextToSurface(LPDIRECTDRAWSURFACE4	lpDDSF, STRING *String, int XPos, int YPos)
{
