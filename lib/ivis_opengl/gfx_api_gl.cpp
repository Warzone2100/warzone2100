...
static const std::map<SHADER_MODE, program_data> shader_to_file_table =
{
	...
	std::make_pair(SHADER_WATER_DEPTH_PREPASS_DEPTHONLY, program_data{ .friendly_name = "water_depth_prepass depth-only program", .vertex_file = "shaders/water_depth_prepass.vert", .fragment_file = "shaders/prepass_depth_only.frag",
		.uniform_names = {},
		.uniform_block_names = { "cbuffer" } }),
	std::make_pair(SHADER_WATER_DEPTH_PREPASS_BUMP, program_data{ .friendly_name = "water bump depth prepass program", .vertex_file = "shaders/water_depth_prepass_bump.vert", .fragment_file = "shaders/water_depth_prepass_bump.frag",
		.uniform_names = {},
		.additional_samplers = { {"tex_nm", 0} },
		.uniform_block_names = { "cbuffer" } }),
	...
	std::make_pair(SHADER_SSAO_BLUR, program_data{ .friendly_name = "SSAO blur program", .vertex_file = "shaders/postprocess_fullscreen.vert", .fragment_file = "shaders/ssao_blur.frag",
		...
		.uniform_block_names = { "cbuffer" } }),
	std::make_pair(SHADER_BILINEAR_RESAMPLE, program_data{ .friendly_name = "bilinear resample program", .vertex_file = "shaders/postprocess_fullscreen.vert", .fragment_file = "shaders/bilinear_resample.frag",
		.uniform_names = {},
		.additional_samplers = { {"sourceTexture", 0} },
		.uniform_block_names = { "cbuffer" } }),
	...
	std::make_pair(SHADER_SSR_BLUR, program_data{ .friendly_name = "SSR blur program", .vertex_file = "shaders/postprocess_fullscreen.vert", .fragment_file = "shaders/ssr_blur.frag",
		.uniform_names = {},
		.additional_samplers = { {"ssrTexture", 0}, {"depthTexture", 1} },
		.uniform_block_names = { "cbuffer" } }),
	std::make_pair(SHADER_SCENE_COMPOSE_SSR, program_data{ .friendly_name = "Scene compose SSR program", .vertex_file = "shaders/postprocess_fullscreen.vert", .fragment_file = "shaders/scene_compose_ssr.frag",
		.uniform_names = {},
		.additional_samplers = { {"sceneTexture", 0}, {"ssrTexture", 1}, {"prepassNormals", 2}, {"prepassDepth", 3} },
		.uniform_block_names = { "cbuffer" } }),
