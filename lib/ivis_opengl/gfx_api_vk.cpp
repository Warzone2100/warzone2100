...
static const std::map<SHADER_MODE, shader_infos> spv_files
{
	...
	std::make_pair(SHADER_WATER_DEPTH_PREPASS_BUMP, shader_infos{ "shaders/vk/water_depth_prepass_bump.vert.spv", "shaders/vk/water_depth_prepass_bump.frag.spv" }),
	...
	std::make_pair(SHADER_BILINEAR_RESAMPLE, shader_infos{ "shaders/vk/postprocess_fullscreen.vert.spv", "shaders/vk/bilinear_resample.frag.spv" }),
	...
	std::make_pair(SHADER_SSR_GENERATE, shader_infos{ "shaders/vk/postprocess_fullscreen.vert.spv", "shaders/vk/ssr_generate.frag.spv" }),
	std::make_pair(SHADER_SSR_BLUR, shader_infos{ "shaders/vk/postprocess_fullscreen.vert.spv", "shaders/vk/ssr_blur.frag.spv" }),
	std::make_pair(SHADER_SCENE_COMPOSE_SSR, shader_infos{ "shaders/vk/postprocess_fullscreen.vert.spv", "shaders/vk/scene_compose_ssr.frag.spv" }),
