...
enum SHADER_MODE
{
	...
	SHADER_COMPONENT_DEPTH_PREPASS_INSTANCED,
	SHADER_COMPONENT_DEPTH_PREPASS_DEPTHONLY_INSTANCED,
	SHADER_NOLIGHT,
	SHADER_NOLIGHT_INSTANCED,
	SHADER_TERRAIN_DEPTH,
	SHADER_TERRAIN_DEPTHMAP,
	SHADER_TERRAIN_DEPTH_PREPASS,
	SHADER_TERRAIN_DEPTH_PREPASS_DEPTHONLY,
	SHADER_WATER,
	SHADER_WATER_DEPTH_PREPASS,
	SHADER_WATER_DEPTH_PREPASS_DEPTHONLY,
	SHADER_RECT,
	...
	// hardware-tessellated terrain variants (require supportsTessellationShaders())
	SHADER_TERRAIN_DEPTHMAP_TESS,
	SHADER_TERRAIN_DEPTH_PREPASS_TESS,
	SHADER_TERRAIN_DEPTH_PREPASS_TESS_DEPTHONLY,
	SHADER_TERRAIN_COMBINED_MEDIUM_TESS,
	SHADER_TERRAIN_COMBINED_HIGH_TESS,
	SHADER_WATER_CLASSIC,
	SHADER_WATER_HIGH,
	// Render World to Screen
	SHADER_WORLD_TO_SCREEN,
	// FSR 1.0 upscaling (scene to screen)
	SHADER_FSR1_EASU,
	SHADER_FSR1_RCAS,
	// SMAA 1x (scene post-process antialiasing)
	SHADER_SMAA_EDGES,
	SHADER_SMAA_WEIGHTS,
	SHADER_SMAA_BLEND,
