 ...
 ************************************************************************************
**/
char VersionString[VersionStringSize] = "3.0 beta 3"; // used for display in the lobby, not the actual version check
static int NETCODE_VERSION_MAJOR = 3;                // major netcode version, used for compatibility check
static int NETCODE_VERSION_MINOR = 3;               // minor netcode version, used for compatibility check
