 ...
 ************************************************************************************
**/
char VersionString[VersionStringSize] = "2.3 beta12a"; // used for display in the lobby, not the actual version check
static int NETCODE_VERSION_MAJOR = 2;                // major netcode version, used for compatibility check
static int NETCODE_VERSION_MINOR = 66;               // minor netcode version, used for compatibility check
