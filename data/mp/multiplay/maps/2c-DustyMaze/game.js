...
const symmetry = Symmetry.CENTRAL2P; // Symmetry type.

const mapWidth = 63; // Width of the map, in tiles.
const mapHeight = 140; // Height of the map, in tiles.
...
const mazeHeight = 6; // Height of the maze, in cells.
const mazeBaseWidth = 2; // Player base width, in cells.
const mazeBaseHeight = 2; // Player base height, in cells.
const mazeNumExits = 1; // Number of passages between player quarters.
