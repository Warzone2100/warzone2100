...
function buildOrder_StandardFallback()
{
	...
	if (gameTime > 300000)
	{
		...
		if (buildMinimum(structures.labs, derrickCount / 3))
		{
			return true;
		}
		...
		if (needFastestResearch() === PROPULSIONUSAGE.GROUND)
		{
			...
			{
				if (buildMinimum(structures.templateFactories, 1))
				{
					return true;
				}
			}
		...
		if (buildMinimum(structures.vtolFactories, 1))
		{
			return true;
		}
