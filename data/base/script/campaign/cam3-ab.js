...
function nexusManufacture()
{
	...
	for (const factoryTypeItem of factoryType)
	{
		var factories = enumStruct(NEXUS, factoryTypeItem.structure);
		var templs = factoryTypeItem.temps;
