...
vec4 doBumpMapping(BumpData b, vec3 groundLightDir, vec3 groundHalfVec) {
	...
	res += iterateOverAllPointLights(clipSpaceCoord, posModelSpace, tangentToWorld * b.N, tangentToWorld[2], tangentToWorld * normalize(groundHalfVec - groundLightDir), b.color, clampedGloss);
#endif
