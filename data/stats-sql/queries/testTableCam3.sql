SELECT DLookUp("[bodynameQuery]![Component Name]","[bodynameQuery]","[bodynameQuery]![Component ID] = " & [Body ID]) AS BodyName,
       ...
       testTable.id
FROM testTable
WHERE (((DLookUp("[bodynameQuery]![Tecnology Name]","[bodynameQuery]","[bodynameQuery]![Component ID] = " & [Body ID]))="Level Three" Or (DLookUp("[bodynameQuery]![Tecnology Name]","[bodynameQuery]","[bodynameQuery]![Component ID] = " & [Body ID]))="Level Two-Three" Or (DLookUp("[bodynameQuery]![Tecnology Name]","[bodynameQuery]","[bodynameQuery]![Component ID] = " & [Body ID]))="Level All"));
