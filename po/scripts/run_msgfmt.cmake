...
if(NOT REG_RESULT EQUAL 0)
    ...
    if(ERROR_OUTPUT MATCHES ":([0-9]+):")
        ...
        # Read target source array directly
        file(STRINGS ${INPUT_FILE} PO_LINES)
        ...
        if($ENV{GITHUB_ACTIONS})
            ...
            execute_process(COMMAND ${CMAKE_COMMAND} -E echo "::error file=${INPUT_FILE},line=${LINE_NUM},title=Translation Format Mismatch::${CLEAN_REASON}")
        else()
