...
${LangFileString} WZ_ARM64_INSTALL_NON_ARM64 "这是 ARM64 版本的 Warzone 2100，此设备没有 ARM64 处理器，\r$\n请访问https://wz2100.net/下载您系统的适当版本 (例如：x64)$\r$\n仍然继续使用 ARM64 安装？"
...
${LangFileString} DESC_SecFMVs "下载并安装游戏剧情动画。"

${LangFileString} TEXT_SecFMVs_EngHi "英语（高画质）"
...
${LangFileString} DESC_SecFMVs_Ger "下载并安装游戏德语剧情动画。"
...
${LangFileString} TEXT_PromptRebootNeeded "需要重新启动才能完成安装。您想要现在重新启动系统吗？"
