${LangFileString} WZWelcomeText "Ласкаво просимо у програму встановлення Warzone 2100. Наш помічник допоможе Вам під час процесу встановлення програми. Рекомендуємо Вам закрити інші додатки перед продовженням установки. Це дозволить оновлювати відповідні системні файли без перезавантаження Вашого комп'ютера. Warzone 2100 є 100% безплатною, повністю відкритою програмою. Натисніть "Дальше", щоб продовжити."

${LangFileString} WZWelcomeText_Portable "Ласкаво просимо у переносну програму встановлення Warzone 2100. Наш помічник допоможе Вам під час процесу встановлення програми. Рекомендуємо Вам закрити інші додатки перед продовженням установки. Це дозволить оновлювати відповідні системні файли без перезавантаження Вашого комп'ютера. Warzone 2100 є 100% безплатною, повністю відкритою програмою. Натисніть "Дальше", щоб продовжити."
