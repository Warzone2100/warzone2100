...
${LangFileString} WZWelcomeHomepageLink "Visit our Official Homepage at https://wz2100.net for the latest version."
...
${LangFileString} TEXT_PromptRebootNeeded "A reboot is necessary to complete the installation. Reboot the system now?"
${LangFileString} TEXT_MsgRebootFailed "Self-reboot failed. Please reboot manually."
