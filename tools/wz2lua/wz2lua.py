...
if len(sys.argv)>2:
	...
	slotext = load_file(sys.argv[1])

print '-- generated by wz2lua 0.1 from',sys.argv[1],
#print 'dofile("script/event.lua")'
...
if len(sys.argv)>2:
	print 'and', sys.argv[2]
	#stderr.write('Vlo: Tokenizing...\n')
...
for f in called_functions:
	print 'if '+f+' == nil then '+f+' = function() print("stub: '+f+'"); return 0 end end'
