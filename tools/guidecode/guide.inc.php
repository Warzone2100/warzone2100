...
<p>
Designing a new unit is simple. It’s a three-step procedure: selecting a body, a propulsion system, and a turret. The three picked will result in a new unit.</p>
...
A unit that retreats from the battle to go to a repair facility, will stay connected to it’s Commander group. When it is done repairing, it will return to the Commander.</p>
<p>
...
<p>
You can assign all the indirect fire pits and emplacements to a Commander’s designated target, also known as ‘fire support’. To do so, simply select a Commander, open the Commanders menu, and select the above icon. To cancel it, select the same button, or assign the fire support to another commander.</p>',
		'title' => 'Commanders',
...
<p>
Clicking the blank icon above a facility will show a set of icons on the left. You can hold the mouse over an icon to see it’s name. Click an icon to start researching it. Only one center can research one technology at a time.</p>

<p>
While a facility is researching, it displays a bar in it’s Fast Find area. If the bar is green, the facility is gathering power. If it is yellow, the topic is being researched.</p>
<p>
...
<p>
<h4> Oil Derricks </h4>
Oil derricks can only be built on Oil Pools which aren’t on fire. Fires on Oil Pools will burn out over time. Oil derricks are built automatically if a truck is selected and you left-click an Oil Pool.</p>
<p>
...
Please note that while the Intelligence Display pauses the game in Campaign mode, it doesn’t do so in Multiplayer and Skirmish!</p>',
		'title' => 'Intelligence',
